...
namespace customProgressRing.iOS.Renderer
{
    ...
    public class RadialProgressView : UIView
    {
        ...
        public UIColor ProgressColor
        {
            ...
            {
                progressColor = value;
                radialProgressLayer.Colors = ProgressColor;
            }
        }
        public UIColor BGProgressColor
        {
            get
            {
                return bgprogressColor;
            }
            set
            {
                bgprogressColor = value;
                radialProgressLayer.BGColors = BGProgressColor;
            }
        }
        /// <summary>
        ...
        public bool LabelHidden
        {
            get
            {
                return labelHidden;//progressType != RadialProgressViewStyle.Tiny ? labelHidden : true;
            }
            set
            {
        ...
        void InitPercentageLabel()
        {
            ...
            percentageLabel.BackgroundColor = Color.FromHex("#ffffff").ToUIColor().ColorWithAlpha(0.0f);  //UIColor.Clear;
            percentageLabel.TextColor = Color.FromHex("#ffffff").ToUIColor();   //UIColor.White;
            percentageLabel.ShadowColor = Color.FromHex("#000000").ToUIColor().ColorWithAlpha(0.71f);   //UIColor.Black.ColorWithAlpha(0.71f);
